...
<html>
	<head>
        ...
        .myuniversity{width: 815px; background: #fff; border: 1px solid #999; padding: 15px; margin-top: 10px;}
        .dimen{background: #ddd; border: 40px solid #999; font-size: 48px; margin: 40px; padding: 50px; text-align: center;}
	...
	<body>
        <div class="phpcoding">
			<section class="headeroption">
			        <h2><?php echo "jQuery: Dimension"; ?></h2>
			</section>
