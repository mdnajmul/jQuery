...
<html>
	<head>
        ...
        .text{border: 1px solid #999; border-radius: 20px; color: green; padding: 10px;}
        .bg{background: black; color: #fff;}
        .text1{border: 2px solid red; border-radius: 20px; color: blue; padding: 10px;}
        .bg1{background: yellow; color: #000;}  
		</style>
	...
	<body>
        <div class="phpcoding">
			<section class="headeroption">
			        <h2><?php echo "jQuery: CSS Classes"; ?></h2>
			</section>
