...
<html>
	<head>
        ...
        .myuniversity{height: 200px; width: 815px; background: #fff; border: 1px solid #999; padding: 15px; margin-top: 10px; display: none;}   
		</style>
	...
	<body>
        <div class="phpcoding">
			<section class="headeroption">
			        <h2><?php echo "jQuery: fadeIn(), fadeOut(), fadeTo(), fadeToggle()"; ?></h2>
			</section>
